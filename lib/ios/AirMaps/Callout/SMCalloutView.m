...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.containerView.backgroundColor = [UIColor colorWithRed:0.05 green:0.61 blue:0.41 alpha:1.0];
        ...
        if (!blackArrowImage) {
            ...
            whiteArrowImage = [self image:blackArrowImage withColor: [UIColor colorWithRed:0.05 green:0.61 blue:0.41 alpha:1.0] ];
            grayArrowImage = [self image:blackArrowImage withColor: [UIColor colorWithRed:0.05 green:0.61 blue:0.41 alpha:1.0] ];
        }
